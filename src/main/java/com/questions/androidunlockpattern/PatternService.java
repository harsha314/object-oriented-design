...
import com.questions.androidunlockpattern.PatternHasherTest.Hashed;
...
public class PatternService {
  ...
  public void setPattern(String userId, List<Integer> points) {
    try {
      Hashed hashInfo = PatternHasherTest.hash(points);
  ...
  public boolean verifyPattern(String userId, List<Integer> points) {
    try {
      ...
      boolean result = PatternHasherTest.verify(points, patternInfo.saltBase64(), patternInfo.hashBase64());
